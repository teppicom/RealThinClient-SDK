object Form2: TForm2
  ...
  Width = 799
  Height = 598
  Caption = 'RTC Fish Facts Client (RtcClientDataSet version)'
  Color = clBtnFace
  ...
  object DataSource1: TDataSource
    DataSet = RtcClientDataSet1
    Left = 188
    Top = 228
  end
  object RtcClientDataSet1: TRtcClientDataSet
    Aggregates = <>
    Params = <>
    TrackChanges = True
    OnDataChange = RtcClientDataSet1DataChange
    Left = 188
    Top = 176
  end
